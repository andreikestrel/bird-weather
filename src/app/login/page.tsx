    ...
    <main className="min-h-screen flex items-center justify-center px-4 pt-20 relative z-10">
      <div className="glass-card p-8 sm:p-10 w-full max-w-md text-center">
        ...
        <p className="text-white/60 text-sm mb-8">
          Entre com sua conta Google para acessar alertas personalizados
        </p>
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 h-12 rounded-xl bg-white text-gray-800 font-semibold text-sm hover:bg-gray-50 transition-colors shadow-lg"
          >
